    ...
    return (
      <div className="mt-4">
        <button
          ...
          className="inline-flex items-center rounded-md border border-accent-concern-border bg-accent-concern-soft px-3 py-1.5 text-xs font-medium text-accent-concern-text hover:bg-accent-concern-soft-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
        >
          Delete my account
        </button>
      </div>
    ...
    <div className="mt-4 rounded-md border border-accent-concern-border bg-accent-concern-soft p-4">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <button
          ...
          onClick={onSubmit}
          disabled={!canSubmit}
          className="inline-flex items-center rounded-md bg-accent-concern px-3 py-1.5 text-xs font-medium text-accent-concern-on hover:bg-accent-concern-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-canvas disabled:cursor-not-allowed disabled:opacity-50"
        >
