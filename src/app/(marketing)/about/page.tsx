 ...
 *
 * Voice note for Robert: these sentences are in my voice. Every paragraph
...
/**
 * Placeholder string for Robert's bio — intentionally bracketed so the
 * copy-pin test in `src/app/(marketing)/page.test.ts` fails if this
 * ships unedited. Replace with 1–3 sentences in Robert's voice. Keep
 * the leading `{bio:` and trailing `}` for the test to recognise it
 * as intentional rather than accidental.
 */
const PLACEHOLDER_BIO =
  "{bio: years shipping product copy, notable teams or companies, anything Robert wants surfaced here. Brackets make this block fail the copy-pin test until edited}";
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-20">
      ...
      <Section title="Who wrote the model">
        <p>
          Robert Ballard, a staff-level content designer. {PLACEHOLDER_BIO} The pattern
      ...
      <Section title="Why the model stays honest">
        ...
        <p className="mt-3">
          ...
          time Robert dismisses a verdict as &ldquo;the standard doesn&apos;t
