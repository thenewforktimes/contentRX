...
def humanize_review_reason(value: str | None) -> str:
    ...
    LLM clients should prefer this label when surfacing a
    `review_recommended` finding to the user — the substrate enums
    leak engine-pipeline vocabulary that doesn't belong on a customer
    surface.
